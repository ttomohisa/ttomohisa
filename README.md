...
| [Max Text Print](https://github.com/ttomohisa/htmlapps-max-text-print)                           | Fit entered text to the largest size that stays within A4, optionally split it across multiple sheets, and send the result directly to the browser's print dialog.                       |
...
| [Photo Re-Enactor](https://github.com/ttomohisa/htmlapps-photo-re-enactor)                       | Recreate an earlier photo composition by overlaying a reference image on the live camera, with Ghost, Outline, Blink, Split, local composition guidance, and portable comparison export. |
...
| [One Second Montage](https://github.com/ttomohisa/htmlapps-one-second-montage)       | Turn mixed photos and videos into an MP4 montage using one second from each item, with automatic video highlight selection, optional looping music, and capture-year dividers. |
...
### 📱 Camera, presentation, device & everyday utilities

| Project                                                                            | What it does                                                                                                                                                                      |
| ---------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Presentation Remote](https://github.com/ttomohisa/htmlapps-presentation-remote)   | Open a local PPTX or PDF on a computer and control the presentation from a phone over direct WebRTC, including Presenter View with current/next-slide previews and speaker notes. |
| [Gesture Presentation](https://github.com/ttomohisa/htmlapps-gesture-presentation) | Present PDFs or images and move between pages with local hand-gesture recognition, plus a serverless two-step QR WebRTC Air Remote.                                               |
